...
export default function drawPip(ctx, suit, shadow, deckBack) {
    if (suit.pip === 'multi') {
        var suits = [{'pip': 'multi_red', 'fill':'#aa0000'}, {'pip': 'multi_green', 'fill':'#00cc00'}, {'pip': 'multi_white', 'fill':'#bbbbbb'}, {'pip': 'multi_blue', 'fill':'#0044cc'}, {'pip': 'multi_yellow', 'fill':'#ccaa22'}, {'pip': 'multi_center', 'fill':'#bbbbbb'}]
        for (let s of suits) {
    ...
    } else if (suit.fill === 'separate_multi') {
        // after
    } else {
